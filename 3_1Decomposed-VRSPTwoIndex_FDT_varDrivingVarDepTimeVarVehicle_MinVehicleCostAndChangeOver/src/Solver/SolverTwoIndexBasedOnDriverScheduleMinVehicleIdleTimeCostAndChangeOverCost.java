...
//
    ...
    public Solution solveWithCplexBasedOnGivenSchedules() {
        try {
            ...
            cnstDetectDriverShortConnectionArc();//(42)// 修改了，这个之前有个不等号符号写错了20250709
//            cnstDetectDriverShortConnectionArc2();// new add 2025.2.4
//
...
//            cnstWhetherIsShortLinkMinAndShortDriver();//2025.2.5
            ...
            cnstDetectOneVehicleShortConnectionArcForAllCombined();//(40)//change 2025.1.20// change 2025.7.9
...
//             //link  vehicle short connection and vehicle arc
//            cnstLinkWhetherVehicleShortConnectionWhetherTwoPerformArc();// new add 2025.2.4
...
//            cplex.setParam(IloCplex.Param.MIP.Tolerances.MIPGap, 1e-09);
            ...
            cplex.setParam(IloCplex.Param.MIP.Tolerances.Integrality, 1e-7);
        ...
        for (int i = 0; i < nbTrip; i++) {
            ...
            for (int j = 0; j < nbTrip; j++) {
                ...
                if (instance.whetherHavePossibleArcAfterCleaning(i, j) && nbVehicleNeed_i == 2 && nbVehicleNeed_j == 2) {
                    ...
                    IloConstraint constraint = cplex.addGe(expr, 0);//这个地方不等式符合写反了修改了2025.7.9
                }
            }
        }
//        }
...
//        InstanceReader reader = new InstanceReader("largerExample.txt");
        InstanceReader reader1 = new InstanceReader("inst_nbCity03_Size90_Day1_nbTrips150_combPer0.25_TW6.txt");

        Instance instance = reader1.readFile(); //这个语句将文本的内容就读出来了
        System.out.println(instance);


        SchedulesReader reader2 = new SchedulesReader("scheduleSolution_inst_nbCity03_Size90_Day1_nbTrips150_combPer0.25_TW6.txt", instance);
        ...
        SolverTwoIndexBasedOnDriverScheduleMinVehicleIdleTimeCostAndChangeOverCost solverWithFormulation1 = new SolverTwoIndexBasedOnDriverScheduleMinVehicleIdleTimeCostAndChangeOverCost(instance, schedules1, false);
        ...
        if (sol != null) {
            sol.printInfile("sol_inst_nbCity03_Size90_Day1_nbTrips150_combPer0.25_TW6.txt");
        }

        solverWithFormulation1.initializeResidualCapacityMatrixForAllTrips();
        solverWithFormulation1.getSolutionObtainedByFlowMatrixInformation();
