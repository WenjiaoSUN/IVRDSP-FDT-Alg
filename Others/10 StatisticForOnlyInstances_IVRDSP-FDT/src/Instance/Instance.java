...
//        return whetherHavePossibleArc;
    ...
    // ***********  the following part is to  do the statistics for the instances

    public int getNbCombinedTrips() {
    ...
    public double getActualPercentageOfCombine() {
    ...
    public int getNbCombineTripStartFromDepotAndEndAtDepot() {
    ...
    public int getNbCombineTripStartFromDepotAndEndAtNonDepot() {
    ...
    public int getNbCombineTripStartFromNonDepotEndAtDepot() {
    ...
    public int getNbCombineTripStartFromNonDepotEndAtNonDepot() {
    ...
    public int getNbNormalTripStartFromDepotEndAtDepot() {
    ...
    public int getNbNormalTripStartFromDepotEndAtNonDepot() {
    ...
    public int getNbNormalTripStartFromNonDepotEndAtDepot() {
    ...
    public int getNbNormalTripStartFromNonDepotEndAtNonDepot() {
    ...
    public int getDepartureTimeLength(){
        int length=0;
        length=this.getMaxFolderOfTimeSlotAsTimeWindow()*this.getTimeSlotUnit()*2+1;
        return length;
    }
...
//                + "\t" + "minWorkingTime: " + minWorkingTime + "\t"+ "maxWorkingTime: " + maxWorkingTime;
    ...
    public static void main(String[] args) {
        InstanceReader reader = new InstanceReader("inst_nbCity03_Size90_Day1_nbTrips025_combPer0.25_TW1.txt");
        Instance instance = reader.readFile();
        System.out.println(instance.getDepartureTimeLength());
    }
