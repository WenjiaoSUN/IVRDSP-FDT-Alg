...
public class Solution {
    ...
    public double getTotalChangeoverCostForAllDriver() {
        ...
        for (int d = 0; d < this.pathForDrivers.size(); d++) {
            ...
            ArrayList<TripWithDriveInfos> pathForDriver = this.pathForDrivers.get(d).getTripWithDriveInfosArrayList();
...
//            for (int i = 0; i < p.getTripWithDriveInfosArrayList().size() - 1; i++) {
...
//                    TripWithDriveInfos lFirst = p.getTripWithDriveInfosArrayList().get(i);
//                    TripWithDriveInfos lSecond = p.getTripWithDriveInfosArrayList().get(i+1);
//
...
//    }
    ...
    public static void main(String[] args) {
        ...
        InstanceReader reader = new InstanceReader("inst_nbCity03_Size90_Day1_nbTrips035_combPer0.0_TW4.txt");
