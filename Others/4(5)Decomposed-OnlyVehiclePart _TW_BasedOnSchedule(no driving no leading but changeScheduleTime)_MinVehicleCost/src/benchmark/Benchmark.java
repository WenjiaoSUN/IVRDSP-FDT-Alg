...
import Solver.SolverTwoIndexBasedOnDriverScheduleWithNoChangeOver;
...
//                String solutionFileName = "solution_" + fileName;
                String solutionFileName = "MergedSolutionArcTimeInforms_" + fileName;//
...
////                        //the following two line is when we solve with no warm file and also no consider changeoverCost
                        SolverTwoIndexBasedOnDriverScheduleWithNoChangeOver solverBasedOnDriverSchedule = new SolverTwoIndexBasedOnDriverScheduleWithNoChangeOver(instance, driverSchedules, whetherSolveRelaxationProblem);
