...
import Solver.SolverWithFormulation_2;
...
public class Benchmark {
    ...
    public static void solveFromFiles() throws IloException {
        ...
        writer.println("name,minPlanTime,maxPlanTime,shortConTimeDriver,shortConTimeVehicle,maxDrivingTime,maxWorkingTime,nbCities,nbTrips,nbNodes," +
                "nbMaxPossibleArcs,maxPercentCombine,maxFolderOfTimeSlotAsTimeWindow,maxNbDriverAvailable,maxNbVehicleAvailable," +
        ...
        if (f.isDirectory()) {
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                ...
                if (fileName.startsWith("inst_") && fileName.endsWith(".txt")) {
                    ...
                    SolverWithFormulation_2 solverWithWarmStart = new SolverWithFormulation_2(instance, warmStartFilePath, whetherSolveRelaxationProblem);
...
//                    Solution sol = solver.solveWithCplex();
                    ...
                    writer.print(instance.getMaxNbPossibleArcs() + ",");
