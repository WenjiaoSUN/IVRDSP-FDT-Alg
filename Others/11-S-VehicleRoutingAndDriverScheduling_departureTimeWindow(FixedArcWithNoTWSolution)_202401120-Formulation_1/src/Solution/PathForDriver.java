...
//                if() {
                    ...
                    System.out.println("Now the idle time in driver_"+idOfDriver+" path between trip_"+idOfFormerTrip+" to trip_" +idOfLatterTrip+" is "+connectionTime);
                    System.out.println("Driver_"+idOfDriver+" path cost until trip_" +idOfLatterTrip+" is"+idleTimeCost);
...
//                }
    ...
    public String toString() {
        String s=idOfDriver+ " "+driverPath.size();
        for(int i=0;i<driverPath.size();i++){
            s+=" "+driverPath.get(i).getIdOfTrip()+" "+driverPath.get(i).getIdOfVehicle()+" "+driverPath.get(i).getDrivingStatus();
        }
