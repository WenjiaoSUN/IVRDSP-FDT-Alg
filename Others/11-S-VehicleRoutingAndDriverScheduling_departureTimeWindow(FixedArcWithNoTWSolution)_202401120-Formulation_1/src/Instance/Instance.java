...
//    }
    ...
    public int getMaxWaitingTime(int idFirstTrip, int idSecondTrip){
        ...
        if (this.whetherHavePossibleArcAfterCleaning(idFirstTrip, idSecondTrip)) {
            ...
            if(idFirstTrip==33&&idSecondTrip==15){
                System.out.println("maxWaitingTime between 33 to 15: "+maxWaitingTime);
            }

            if(idFirstTrip==14&&idSecondTrip==34){
                System.out.println("maxWaitingTime between 14 to 34: "+maxWaitingTime);
            }

//            if(idFirstTrip==14&&idSecondTrip==15){
//                System.out.println("maxWaitingTime between 14 to 15: "+maxWaitingTime);
//            }
//
//            if(idFirstTrip==14&&idSecondTrip==34){
//                System.out.println("maxWaitingTime between 14 to 34: "+maxWaitingTime);
