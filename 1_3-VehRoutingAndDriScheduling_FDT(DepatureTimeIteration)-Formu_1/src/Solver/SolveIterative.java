...
//            int timeMidTW= timeStartTW+(timeEndTW-timeStartTW)/2;
    ...
    public static void main(String[] args) throws IloException {
        ...
        InstanceReader reader1 = new InstanceReader("inst_nbCity03_Size90_Day1_nbTrips025_combPer0.0_TW0.txt");

        Instance instance = reader1.readFile(); //这个语句将文本的内容就读出来了
        System.out.println(instance);

        String warmStartPath = "feaSol_nbCity03_Size90_Day1_nbTrips025_combPer0.0_TW0.txt";
        ...
        if (sol != null) {
            sol.printInfile("sol_nbCity03_Size90_Day1_nbTrips025_combPer0.0_TW0.txt");
